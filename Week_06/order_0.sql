...
Source Database       : order_0

Target Server Type    : MYSQL
Target Server Version : 80018
File Encoding         : 65001

Date: 2021-04-23 11:42:51
*/
...
CREATE TABLE `t_order_0` (
  `order_id` bigint(32) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='订单表';
...
CREATE TABLE `t_order_item_0` (
  ...
  KEY `idx_order_item_order_time` (`order_time`)
...
CREATE TABLE `t_product` (
  ...
  KEY `idx_user_product_code` (`code`)
